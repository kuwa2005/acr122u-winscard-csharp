...
- [新カード情報表示プログラム Phase 1 検証レポート](../testing/new-card-info-viewer-phase1-test-report.md)
- [新規カード情報表示プログラム 品質チェックレポート](../testing/new-card-info-viewer-quality-report.md)
- [新規カード情報表示プログラム コードレビュー](../reviews/new-card-info-viewer-code-review.md)
- [README](../../README.md)
...
- `CardReader_TestConsole` は Phase 1 の一部を確認する既存コンソールであり、新規 `Acr122uCardInspector` の最終仕様ではありません。
- 品質チェックとコードレビューでは、正式 CLI オプション、JSON / Markdown 出力、非対話実行、read-only default が要修正として残っています。
